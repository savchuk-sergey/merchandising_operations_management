    ...
    <div className="container center">
      ...
      <form onSubmit={submitHandler}>
        <div className='z-depth-3 custom-container '>
          ...
          <input type="text" name="item" id="pack" value={pack.pack} onChange={changeHandler} required/><br/>

          <label htmlFor="item_type">Supplier ID</label>
          <input type="text" name="itemType" id="supplier_id" value={pack.supplier_id} onChange={changeHandler}
                 required/><br/>

          <label htmlFor="description">Pack Quantity</label>
          <input type="text" name="description" id="pack_qty" value={pack.pack_qty} onChange={changeHandler}
                 required/><br/>

          <label htmlFor="start_retail">Item No</label>
          <input type="number" name="startRetail" id="item_id" value={pack.item_id} onChange={changeHandler}
                 required/><br/>

          <label htmlFor="uom">Description</label>
          <input type="text" name="uom" id="description" value={pack.description} onChange={changeHandler} required/><br/>

          <label htmlFor="uom">Cost</label>
          <input type="text" name="uom" id="cost" value={pack.cost} onChange={changeHandler} required/><br/>
        </div>
