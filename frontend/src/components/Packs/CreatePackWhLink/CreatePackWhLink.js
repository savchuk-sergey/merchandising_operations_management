...
import {postPackWh, setPackWh} from "../../../redux/reducers/PackWhsReducer";


const CreatePackWhLink = () => {
  const dispatch = useDispatch()
  const packWh = useSelector(state => state.packWhs.packWh)
    ...
    <div className="container center">
      ...
      <form onSubmit={submitHandler}>
        <div className='z-depth-3 custom-container'>
          ...
          <input type="text" name="pack" id="pack" value={packWh.pack} onChange={changeHandler} required/><br/>

          <label htmlFor="wh">Wh</label>
          <input type="text" name="wh" id="wh" value={packWh.wh} onChange={changeHandler}
                 required/><br/>
        </div>
