        ...
        >
          ...
          <Collapsible accordion className='noselect'>
              ...
              >
                <ul>
                  <li>
                    <NavLink to='/Promotions'>List Promotions</NavLink>
                  </li>
                  <li>
                    <NavLink to='/PromotionsCreate'>Create Promotions</NavLink>
                  </li>
                  <li>
                    <NavLink to='/ChangePrice'>Change Price</NavLink>
                  </li>
                </ul>
            ...
            >
              <ul>
                ...
                <li>
                  <NavLink to='/ItemsCreate'>Create Items</NavLink>
                </li>
                <li>
                  <NavLink to='/ItemStoreLinks'>Item Store Link List</NavLink>
                </li>
                <li>
                  <NavLink to='/ItemStoreLinkCreate'>Create Item Store Link</NavLink>
                </li>
              </ul>
            </CollapsibleItem>
            ...
            >
              <ul>
                ...
                <li>
                  <NavLink to='/CreatePack'>Create Packs</NavLink>
                </li>
                <li>
            ...
            >
              <ul>
                ...
                <li>
                  <NavLink to='/StoresCreate'>Create Stores</NavLink>
                </li>
              </ul>
            </CollapsibleItem>
            ...
            >
              <ul>
                ...
                <li>
                  <NavLink to='/SuppliersCreate'>Create Suppliers</NavLink>
                </li>
              </ul>
            </CollapsibleItem>
            ...
            >
              <ul>
                ...
                <li>
                  <NavLink to='/OrdersCreate'>Create Orders</NavLink>
                </li>
                <li>
            ...
            >
              <ul>
                <li>
                  <NavLink to='/Shipments'>List Shipments</NavLink>
                </li>
                <li>
                  <NavLink to='/ShipmentsCreate'>Create Shipments</NavLink>
                </li>
                <li>
